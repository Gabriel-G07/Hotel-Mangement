...
const breadcrumbs: BreadcrumbItem[] = [
    {
        ...
        href: 'housekeeping/management/settings/profile',
    },
];
...
export default function Profile({ mustVerifyEmail, status }: { mustVerifyEmail: boolean; status?: string }) {
    ...
    const submit: FormEventHandler = (e) => {
        ...
        patch(route('housekeeping.management.settings.profile.update'), {
            ...data,
            preserveScroll: true,
        });
    };
                    ...
                    <div className="space-y-6">
                        ...
                        {!isVerified && (
                            <AuthenticateUser
                                ...
                                route={route('housekeeping.management.settings.profile.verify-password')}
                            />
                        )}
