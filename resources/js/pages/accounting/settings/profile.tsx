...
import AppLayout from '@/layouts/app/accounting/app-layout';
import AccountingSettingsLayout from '@/layouts/settings/accounting_layout';
import AuthenticateUser from '@/components/verify-user';

const breadcrumbs: BreadcrumbItem[] = [
    {
        title: 'Profile settings',
        href: '/accounting/settings/profile',
    },
];
...
export default function Profile({ mustVerifyEmail, status }: { mustVerifyEmail: boolean; status?: string }) {
    ...
    const submit: FormEventHandler = (e) => {
        ...
        patch(route('accounting.settings.profile.update'), {
            ...data,
            preserveScroll: true,
        });
    };
                    ...
                    <div className="space-y-6">
                        ...
                        {!isVerified && (
                            <AuthenticateUser
                                ...
                                route={route('accounting.settings.profile.verify-password')}
                            />
                        )}
