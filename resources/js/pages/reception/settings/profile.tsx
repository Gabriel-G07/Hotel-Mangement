...
import SettingsLayout from '@/layouts/settings/reception_layout';
import AuthenticateUser from '@/components/verify-user';

const breadcrumbs: BreadcrumbItem[] = [
    {
        title: 'Profile settings',
        href: '/reception/settings/profile',
    },
];
...
export default function Profile({ mustVerifyEmail, status }: { mustVerifyEmail: boolean; status?: string }) {
    ...
    const submit: FormEventHandler = (e) => {
        ...
        patch(route('reception.settings.profile.update'), {
            ...data,
            preserveScroll: true,
        });
    };
                    ...
                    <div className="space-y-6">
                        ...
                        {!isVerified && (
                            <AuthenticateUser
                                ...
                                route={route('reception.settings.profile.verify-password')}
                            />
                        )}
