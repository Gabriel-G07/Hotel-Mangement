...
import AppLayout from '@/layouts/app/restaurant/app-layout';
import SettingsLayout from '@/layouts/settings/restaurant_layout';
...
export default function Profile({ mustVerifyEmail, status }: { mustVerifyEmail: boolean; status?: string }) {
    ...
    const submit: FormEventHandler = (e) => {
        ...
        patch(route('restaurant.settings.profile.update'), {
            ...data,
            preserveScroll: true,
        });
    };
                    ...
                    <div className="space-y-6">
                        ...
                        {!isVerified && (
                            <AuthenticateUser
                                ...
                                route={route('restaurant.settings.profile.verify-password')}
                            />
                        )}
