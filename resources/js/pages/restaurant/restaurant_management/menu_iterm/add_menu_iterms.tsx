...
import MenuItermsLayout from '@/pages/restaurant/restaurant_management/menu_iterms';
...
const breadcrumbs: BreadcrumbItem= [
    {
        title: 'Add User',
        href: 'restaurant/management/menu_iterms/add',
    },
];
...
export default function AddUsers({ roles }: AddUsersProps) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        router.post('/restaurant/management/menu_iterms', formData);
    };
