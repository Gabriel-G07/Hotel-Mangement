...
const sidebarNavItems: NavItem[] = [
    {
        title: 'Profile',
        url: '/accounting/settings/profile',
        icon: null,
    },
    {
        title: 'Password',
        url: '/accounting/settings/password',
        icon: null,
    },
    {
        title: 'Appearance',
        url: '/accounting/settings/appearance',
        icon: null,
    },
];

export default function AccountingSettingsLayout({ children }: PropsWithChildren) {
