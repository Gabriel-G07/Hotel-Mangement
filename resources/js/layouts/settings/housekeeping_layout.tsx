...
const sidebarNavItems: NavItem[] = [
    {
        title: 'Profile',
        url: '/housekeeping/settings/profile',
        icon: null,
    },
    {
        title: 'Password',
        url: '/housekeeping/settings/password',
        icon: null,
    },
    {
        title: 'Appearance',
        url: '/housekeeping/settings/appearance',
        icon: null,
    },
];

export default function HouseKeepingSettingsLayout({ children }: PropsWithChildren) {
