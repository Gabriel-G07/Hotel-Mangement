...
class RestaurantTillProfileController extends Controller
{
    /**
    ...
    {
        return Inertia::render('restaurant/settings/profile', [
    ...
    public function verifyPassword(Request $request): RedirectResponse
    {
        ...
        return to_route('restaurant.settings.profile.edit')->with('success', 'Password verified successfully.');
    }
    ...
    public function update(ProfileUpdateRequest $request): RedirectResponse
    {
        ...
        return to_route('restaurant.settings.profile.edit')->with('success', 'Profile updated successfully.');
    }
