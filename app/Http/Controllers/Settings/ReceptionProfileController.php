...
class ReceptionProfileController extends Controller
{
    ...
    {
        return Inertia::render('reception/settings/profile', [
    ...
    public function verifyPassword(Request $request): RedirectResponse
    {
        ...
        return to_route('reception.settings.profile.edit')->with('success', 'Password verified successfully.');
    }
    ...
    public function update(ProfileUpdateRequest $request): RedirectResponse
    {
        ...
        return to_route('reception.settings.profile.edit')->with('success', 'Profile updated successfully.');
    }
