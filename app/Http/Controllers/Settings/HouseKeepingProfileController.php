...
class HouseKeepingProfileController extends Controller
{
    /**
    ...
    {
        return Inertia::render('housekeeping/settings/profile', [
    ...
    public function verifyPassword(Request $request): RedirectResponse
    {
        ...
        return to_route('housekeeping.settings.profile.edit')->with('success', 'Password verified successfully.');
    }
    ...
    public function update(ProfileUpdateRequest $request): RedirectResponse
    {
        ...
        return to_route('housekeeping.settings.profile.edit')->with('success', 'Profile updated successfully.');
    }
