...
class AccountingProfileController extends Controller
{
    ...
    {
        return Inertia::render('accounting/settings/profile', [
    ...
    public function verifyPassword(Request $request): RedirectResponse
    {
        ...
        return to_route('accounting.settings.profile.edit')->with('success', 'Password verified successfully.');
    }
    ...
    public function update(ProfileUpdateRequest $request): RedirectResponse
    {
        ...
        return to_route('accounting.settings.profile.edit')->with('success', 'Profile updated successfully.');
    }
